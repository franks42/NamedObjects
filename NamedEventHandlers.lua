...
-------------------------------------------------------------------------------
--- Test local event handler - fires once, prints out stuff and self-destructs
NamedEventHandlers.localEventTestHandler = function(event)
	print("localEventTestHandler:",NamedEventHandlers.localEventTestHandler)
	NamedObjects.dumpKV(event, "event")
	local self = event.target
	self:removeEventListener(event.name, NamedEventHandlers.localEventTestHandler)
	return false 
end
NamedObjects.registerNameObject("localEventTestHandler",NamedEventHandlers.localEventTestHandler,"PermanentContext")
